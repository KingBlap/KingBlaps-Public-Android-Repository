...
## Contents
- **Kodi 21.3 Builds:** Prebuilt APKs and installer packages for quick setup.
- **Kodi Backups:** Add-ons, skins, settings, and configuration files for easy restoration.
...
### Device Setup Guide
Before you begin, enable developer mode on your Android device and grant file management permissions to the Downloader and Xplore File Manager app.

- **Android TVs & Fire Sticks:**
  - The Downloader app and the Xplore file manager app is required. Follow the steps down below to download, install assets, and restore Kodi.
  1. Install the Downloader app and Xplore File Manager.
...
- Setting up Kodi:
  1. Make Sure you give Kodi file management permissions in your device settings. 
  2. Open Kodi.
  3. Go to Settings > System > Addons > Enable Unknown Sources.
  4. Go back to Settings > Add ons > install from repository > Kodi Add-on Repository > Program add-ons > Backup > Install.
  5. After installation, go to Settings > Add-ons > Program add-ons > Backup
  6. Go to settings in the Backup add-on and set the backup path to: /storage/emulated/0/Kodi/(Kodi 21.3) KingBlap's Public Android Repository ver 1.0/Kodi Backups/Android Kodi Backups/Jan 11,2026.
  7. Go back to the main menu of the Backup add-on and select Restore.
  8. Select Yes to confirm and wait for the restore process to complete.
  9. Once the restore is complete, Kodi will force close.
  10. Reopen Kodi and go to Settings > interface Settings > Skin > Choose Skin > Select "Xonfluence" > Yes to confirm.
  11. For the Background picture, go to Setting > Skin Settings > Background> Multi-Image> External Storage> storage emulated 0> Kodi> (Kodi 21.3) KingBlap's Public Android Repository ver 1.0> Build> Pictures> Select your desired background.
  12. To Finalize the setup, restart kodi.
   - Enjoy Kodi!
...
## Donate or Tip
Send $5 to $10 in BitCoin if you like the Kodi Setup
